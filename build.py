    ...
    env.globals.update(
        {
            "STATUS_MAP": {
                "early_draft": {
                    "ja": "草案",
                    "ja_en": "草案 (Early Draft)",
                    "ro": "Early Draft",
                    "en": "Early Draft",
                },
                "full_draft": {
                    "ja": "完成稿",
                    "ja_en": "完成稿 (Full Draft)",
                    "ro": "Full Draft",
                    "en": "Full Draft",
                },
                "verified": {
            ...
            "TAG_MAP": {
                "pinan": {"ja": "平安", "ja_en": "平安 (Pinan)"},
                "shitoryu": {"ja": "糸東流", "ja_en": "糸東流 (Shito-ryu)"},
                "extra_kata": {"ja": "追加型", "ja_en": "追加型 (Extra Kata)"},
                "kyu_grade": {"ja": "級位", "ja_en": "級位 (Kyu Grade)"},
                "black_belt": {"ja": "有段", "ja_en": "有段 (Black Belt)"},
                "sentei": {"ja": "選定形", "ja_en": "選定形 (Sentei)"},
                "shitei": {"ja": "指定形", "ja_en": "指定形 (Shitei)"},
                "1st_kyu": {"ja": "一級", "ja_en": "一級 (1st Kyu)"},
                "2nd_kyu": {"ja": "二級", "ja_en": "二級 (2nd Kyu)"},
                "3rd_kyu": {"ja": "三級", "ja_en": "三級 (3rd Kyu)"},
                "4th_kyu": {"ja": "四級", "ja_en": "四級 (4th Kyu)"},
                "5th_kyu": {"ja": "五級", "ja_en": "五級 (5th Kyu)"},
                "6th_kyu": {"ja": "六級", "ja_en": "六級 (6th Kyu)"},
                "7th_kyu": {"ja": "七級", "ja_en": "七級 (7th Kyu)"},
                "8th_kyu": {"ja": "八級", "ja_en": "八級 (8th Kyu)"},
                "9th_kyu": {"ja": "九級", "ja_en": "九級 (9th Kyu)"},
            },
            "CATEGORY_MAP": {
                "block": {
                    "ja": "受け",
        ...
        tabs.append(
            {
                ...
                "label_ja_en": f"{current_style_ja}: {k['kanji']} ({current_style_label}: {k['name']})",
                ...
                tabs.append(
                    {
                        ...
                        "label_ja_en": f"{eq_style_ja}: {eq_obj['kanji']} ({eq_style_label}: {eq_obj['name']})",
